...
<head>
	...
	<title>Agro Mart - Register</title>
    <style>
		...
		<div class="overlay-container">
			<div class="overlay">
				<div class="overlay-panel overlay-right">
					<h1>Agro Mart</h1>
					<p>Welcome to Agromart!<br>Thank you for choosing Agromart, your one-stop destination for all your agricultural needs. To get started, please fill out the registration form.</p>
				</div>
			</div>
		</div>
	</div>
