...
if (isset($_POST['add_submit'])) {
    ...
    $pricetype = addslashes(trim($_POST['pricetype']));
    ...
    if (move_uploaded_file($_FILES['image']['tmp_name'], "images/" . $imagePath)) {
        ...
        $insertQuery = "INSERT INTO product (pname, description, image, price, pricetype, date, userid, status, categoryid) VALUES ('$name', '$description', '$imagePath', '$price', '$pricetype', '$date', '$userid', '$status', '$categoryid')";

        if (mysqli_query($conn, $insertQuery)) {

            echo "<script>alert('Category added successfully');location.href='add-products.php'</script>";
        } else {
            ...
            <div class="col-lg-12">
                ...
                <div class="row g-4">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM product where status= 1 AND userid = '$userid'";
                            $res = mysqli_query($conn,$sql);
                            ...
                            <div class="modal-content" style="width: 500px;">
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 mb-3">
                                            <label class="form-label">Price Type(kg)<span class="text-danger">*</span></label>
                                            <input autocomplete='off' type="number" class="form-control" maxlength="100" required name="pricetype">
                                        </div>
                                        <div class="col-xl-12 mb-3">
