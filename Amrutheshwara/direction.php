...
<head>
	<meta charset="utf-8">
	<title>SHREE AMRUTHESHWARA TEMPLE| DIRECTIONS</title>
	<!-- Stylesheets -->
...
<body>
	...
	<!-- Directions-->
	<h1 style="text-indent:30px; padding-top: 20px;"><b><u>DIRECTION TO SHREE AMRUTHESHWARA TEMPLE </u></b></h1>
	<div class="direction">

		<div class="direc">
			<p>
				Shree Amrutheshwara Temple is situated at Vamanjoor in Thiruvail (a village) of Mangalore Taluk.
				Vamanjoor is a popular locality situated in Mangalore and the pin code of this locality is 575001.
				Shree Kshetra is only 10 kilometres away from the city of Mangalore.
				Mangalore Central Railway Station is 7.3 kilometres away.
			</p>
			<p style="text-indent:30px">From the National Highway 169 (old NH13),that passes from Vamanjoor,it takes a minimum of 5 minutes ie., 2.0 kilometers to reach the Temple .
				After passing the Vamanjoor Junction, approximately within 2 kilometers,take the right route that leads you to the temple.
			</p>
		</div>
		<img src="tempimgs/img73.jpg" height="300px" width="350px" style="border-radius: 10px;" />
	</div>
	<!-- End Directions-->
