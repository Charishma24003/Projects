			 ...
			 <?php
                        ...
                        <tr>
						  ...
						  <td><?php echo $bdate; ?></td>
						   <td><a href="alcontact.php" style="height:100%;width:100% padding:10px 10px; margin:10px 10px;border-radius:5px;color:red" >CONTACT US
						 </a></td>
