...
<head>
	<meta charset="utf-8">
	<title>SHREE AMRUTHESHWARA TEMPLE|VIEW BOOKING</title>
	<!-- Stylesheets -->
...
<body>
	...
	<div class="page-wrapper">
							...
							<nav class="main-menu navbar-expand-md navbar-light">
								...
								<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
									<ul class="navigation clearfix">
										...
										<li class="current dropdown"><a href="vbookseva.php">VIEW BOOKINGS</a>
											<ul>
		...
		<section class="story-section">
			<div class="auto-container">
				<div class="row clearfix" style="padding:0px 10px">
					...
					<div class="content-column col-lg-8 col-md-12 col-sm-12">
						<div class="inner-column">
							...
							<div class="text">
								<p>Shri Amrutheshwara Temple is located at Vamanjoor town nearly 15 kms away on the
									Mangalore-Moodabidri route. This temple is dedicated to Lord Shiva has deep
									historical significance and tremendous following in the local community.</p>
								<p>The Amrutheshwara Temple is open from 6:30 am to 12:30 noon and again from 5 pm to
									7.30 pm.Devotees who travel to this temple from Mangalore also visit Kudupu Shree
									Anantha Padmanabha temple along the way.</p>
							</div>
						</div>
					</div>
					...
					<div class="image-column col-lg-4 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="kamba1.jpg" alt="" class="kambaimg" style="border:5px dashed var(--primary); border-radius:100%;padding:5px; aspect-ratio:1;" />
							</div>
						</div>
					</div>
