...
<body>
	...
	?>
			<div class="hallimg">
				<img  src="../admin/himg/<?php echo $image; ?>" alt="" width="95%" height="300px" />
			</div>

			<div class="hallcontent">
				<h2  align="center"><b>HALL DETAILS</b></h2>
                 	<h4>Hall Name&nbsp &nbsp :&nbsp <?php echo $hallname; ?><br><br>
					Seating Capacity&nbsp &nbsp &nbsp :&nbsp <?php echo $capacity; ?><br><br>
					Hall Charge&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp :&nbsp<?php echo $charge; ?><br><br>
					Advance Amount &nbsp &nbsp &nbsp &nbsp : &nbsp <?php echo $amount; ?><br><br>
					Hall Description&nbsp &nbsp &nbsp &nbsp :&nbsp <?php echo $description; ?>
			</div>
			 <?php
		...
		<div class="hallbookform">
			<h1 align="center" style="margin:25px 25px;">HALL BOOKING</h1>
			<div class="hallform">
				<form class="hallform"  method="post" action="#" enctype="multipart/form-data">
					...
					<input type="email" id="uemail" name="email" value="<?php echo $_SESSION['templeuser']; ?>" placeholder="Enter your email..." style="height:40px" readonly="true"><br><br>
					...
					<label for="uevname"><b>Event Name</b></label><br>
					<input type="text" id="uevname" name="evname" placeholder="Enter the event name..." style="height:40px"><br><br><br>
				...
				if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$query ="INSERT INTO bkhall(uname,email,phone,uaddress,evdate,evname) VALUES('".$uname."','".$email."','".$phone."','".$uaddress."','".$evdate."','".$evname."')";
		...
		echo "<script>
			...
			echo "<script> location.href='vbhall.php'; </script>";
}
 ?>
