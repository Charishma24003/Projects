							...
							<nav class="main-menu navbar-expand-md navbar-light">
								...
								<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
									<ul class="navigation clearfix">
										...
										<li class=" current dropdown"><a href="alabout.php">ABOUT</a>
			...
			<div class="auto-container">
				<div class="row clearfix" style="padding:0px 10px">
					...
					<div class="image-column col-lg-4 col-md-12 col-sm-12">
						<div class="inner-column">
							<div class="image">
								<img src="tempimgs/kamba1.jpg" alt="" class="kambaimg" style="border:5px dashed var(--primary); border-radius:100%;padding:5px; aspect-ratio:1;" />
							</div>
						</div>
					</div>
