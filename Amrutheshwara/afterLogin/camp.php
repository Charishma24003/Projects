...
<body>
	...
	?>
			<div class="campimg">
				<img  src="../admin/campimg/<?php echo $image; ?>"  alt="" width="100%" height="350px" />
				<h4><?php echo $sl; ?><br><b><?php echo $cname; ?></b> <br><?php echo $date; ?><br><?php echo $time; ?></h4>
			</div>
			<!--<div class="campimg">
				<img src="tempimgs/health.jpg" alt="" width="100%" height="350px" />
				<h4>CAMP 2<br><b>Health Checkup Camp</b> <br>01-01-2024<br>01:00pm</h4>
			</div>-->
			 <?php
		...
		<div class="booknow">
			<a href="booknow.php"><button type="submit" style="background-color:var(--primary); margin-bottom:10px;width:100%">
					<h5>BOOKING PAGE</h5>
				</button></a>
		</div>

		<!-- End Story Section 
	<a href="booknow.php"><button type="submit"  style="background-color:var(--primary);font-weight:bold;color:#fff;height:40px">BOOK NOW</button></a>
	-->
