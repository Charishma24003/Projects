...
<body>
	...
	?>
			<div class="hallimg">
				<img src="../admin/bimg/<?php echo $image; ?>" alt="" width="95%" height="400px" />
			</div>
			<div class="hallcontent">
				<h2 style="margin-left:0px"><b>BHARATHANATYA DETAILS</b></h2>
		...
		<div class="hallbookform">
			<h1 align="center" style="margin:25px 25px;">BHARATHANATYA BOOKING</h1>
			<div class="hallform">
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
        ...
        $folder = "bnatimg/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO bkbnatya(sname,pname,email,phone,uaddress,date,image) VALUES('".$sname."','".$pname."','".$email."','".$phone."','".$uaddress."','".$date."','".$filename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' Booking Successfull');
				</script>";
			echo "<script> location.href='vbbnatya.php'; </script>";
        }else{
            echo "<script>
