		...
		<div class="hallbookform">
			...
			<div class="hallform">
				<form class="hallform"  method="post" action="#" enctype="multipart/form-data">
					<label for="campnm"><b>Please select a Voluntary Work</b></label><br>
					<select id="campnm" name="campnm" style="width:100%">
						<option value="blood">Shastriya Sangeetha</option>
						<option value="blood">Annadana</option>
					</select><br><br>
				...
				if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$query ="INSERT INTO bkvworks(campnm,uname,email,phone,uaddress,evdate) VALUES('".$campnm."','".$uname."','".$email."','".$phone."','".$uaddress."','".$evdate."')";
		...
		echo "<script>
			...
			echo "<script> location.href='vbvolunteer.php'; </script>";
}
 ?>
			</div>
		</div>
