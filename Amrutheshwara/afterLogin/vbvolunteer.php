...
<body>
	...
	<div class="page-wrapper">
		...
		<h1 align="center">VOLUNTARY WORK BOOKINGS</h1>
		<table class="vbsevalist" style="margin:25px 45px 25px 85px ; width:90%; height:50% !important;font-size:20px; text-align:center">
		<thead>
