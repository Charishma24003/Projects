...
<head>
    <meta charset="utf-8">
    <title>SHREE AMRUTHESHWARA TEMPLE| SPECIAL DAYS</title>
    <!-- Stylesheets -->
	...
	?>
        <table class="sevalist">
            <tr>
                ...
                <th style="width:20%;">Festival Day</th>
                <th style="width:20%;">Special Sevas</th>
				<th style="width:20%;">Festival Date</th>
...
if(isset($_POST['book']))
{
	...
	$query1 = "insert into bksday (bno,festday,email) values('".$bno."','".$selectano."','".$_SESSION['templeuser']."')";
	mysqli_query($con,$query1) or die(mysqli_error($con));
	echo "<script>
		alert('Booking Done Successfully');
	</script>";
	echo "<script> location.href='alspecialdays.php?sid=$bno'; </script>";
}
?>
...
<tr>
                ...
                <td>Padya Samarpan<br>Panchamrita Snaman</td>
                <td><button type="button" style="margin:10px 10px !important;">BOOK</button></td>
            </tr>
            ...
            <tr>
                ...
                <td>Makhan Mishri<br>Pushpa Archana<br>Laddu Gopal Abhisheka</td>
                <td><button type="button" style="margin:10px 10px !important;">BOOK</button></td>
            </tr>
            ...
            <tr>
                ...
                <td>24-01-2024</td>
                <td>Ram Navami</td>
                <td>Ram Archana Pooja<br> Sita Ram Abhishek<br>Sahasra Nama Havana</td>
                <td><button type="button" style="margin:10px 10px !important;">BOOK</button></td>
            </tr>-->