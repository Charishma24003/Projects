...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="page-title" style="background-image:url(tempimgs/img8.jpg);margin-top:80px">
			<div class="auto-container">
				<h2>VOLUNTARY WORKS</h2>
				<ul class="page-breadcrumb">
					<li><a href="index.php">HOME</a></li>
					<li>Voluntary Works</li>
				</ul>
			</div>
		</section>
		<!--End Page Title-->
	...
	?>
			<div class="campimg">
				...
				<h4><?php echo $sl; ?><br><b><?php echo $vname; ?></b> <br><?php echo $date; ?><br><?php echo $time; ?></h4>
			</div>
			<!--<div class="campimg">
				<img src="tempimgs/img30.jpg" alt="" width="100%" height="350px" />
				<h4>Voluntary Work 2<br><b>ANNADANA</b> <br>03-01-2024<br>01:30pm</h4>
			</div>-->
			 <?php
		...
		<div class="booknow">
			<a href="vbooknow.php"><button type="submit" style="background-color:var(--primary); margin-bottom:10px;width:100%">
					<h5>BOOKING PAGE</h5>
				</button></a>
		</div>
