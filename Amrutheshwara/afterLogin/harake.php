...
<body>
	...
	<div class="page-wrapper">
		...
		<div class="hallbookform">
			<h1 align="center" style="margin:25px 25px;">HARAKE BOOKING</h1>
			<div class="hallform">
				<form class="hallform"  method="post" action="#" enctype="multipart/form-data">
					<label for="usernm"><b>Name</b></label><br>
					...
					<input type="text" id="uphn" name="phone" style="height:40px"><br><br>

					<label for="hnm"><b>Harake Name</b></label><br>
					<input type="text" id="hnm" name="harake" style="height:40px"><br><br>
					
					<label for="uaddress"><b>Reason behind the harake</b></label><br>
					<textarea id="uaddress" name="rharake" rows="10" cols="30"  style="width:100%"></textarea><br><br>

					<label for="uevdate"><b>Harake Date</b></label><br>
					<input type="date" id="uevdate" name="hdate" style="height:40px"><br><br>
				...
				if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$phone=$_POST['phone'];
		$harake=$_POST['harake'];
		$rharake=$_POST['rharake'];
		$hdate=$_POST['hdate'];
		$date=$_POST['date'];

		$query ="INSERT INTO bkharake(uname,email,phone,harake,rharake,hdate,date) VALUES('".$uname."','".$email."','".$phone."','".$harake."','".$rharake."','".$hdate."','".$date."')";
		...
		echo "<script>
			...
			echo "<script> location.href='vbharake.php'; </script>";
}
 ?>
			</div>
		</div>
