...
<head>
	<meta charset="utf-8">
	<title>SHREE AMRUTHESHWARA TEMPLE| DONATION</title>
	<!-- Stylesheets -->
...
<body>
	...
	<div class="page-wrapper">
							...
							<nav class="main-menu navbar-expand-md navbar-light">
								...
								<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
									<ul class="navigation clearfix">
										...
										<li class="current"><a href="donation.php">DONATION</a>
										</li>
		...
		<!-- End Main Header -->
		<div class="donation">
			<form style="font-size:20px;color:red; border:5px solid var(--primary);  margin-top:80px; margin-left:30px">
				<p style="font-size:20px;color:black;text-decoration: underline; margin-top:80px">
					<u><b></b></u><b>Shree Amrutheshwara Temple, Thiruvail, Vamanjoor</b>
				</p>
				<p class="bankn" style="font-size:20px;">Bank Name &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <b>Vamanjoor
						Bank</b></p>


				<p style="font-size:20px;">Account No&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<b> 4300991019302</b></p>


				<p style="font-size:20px;">IFSC Code &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <b>VAMA0000566</b></p>


				<p style="font-size:20px;">Bank Branch&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;<b>Vamanjoor</b></p>

			</form>
		</div>
		<marquee><b>
				<font color="black">Note: If any payments are done please drop a message to this email</font> <a href="mailto:shreeamrutheshwaratemple@gmail.com">shreeamrutheshwaratemple@gmail.com</a>
			</b>
		</marquee>
