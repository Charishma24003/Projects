    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Bharathanatya Bookings</h4>
		...
		<?php
								...
								$email=$row1['email'];
								$phone=$row1['phone'];
								$uaddress=$row1['uaddress'];
								$date=$row1['date'];
							
	?>
			<tr style="height:60px">
				<td><?php echo $sl; ?></td>
				<td><img  src="bnatimg/<?php echo $image; ?>" alt="error" style="width:140px; height:140px; padding:10px 10px;"></td>
				...
				<td><?php echo $date; ?></td>
				<td><button style="height:100%;width:100%" ><img src="tempimgs/waicon.png" alt="" height="50px" width="80px"> </button></td>
			</tr>
			<?php
