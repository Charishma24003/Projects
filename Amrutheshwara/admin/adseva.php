        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Seva</h4>
                  <form class="forms-sample" method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="sevanm">Seva Name</label>
                      <input type="text" name="sevaname" class="form-control" id="sevanm" placeholder="Name">
                    </div>
                    <div class="form-group">
                      <label for="sevaprice"> Price</label>
                      <input type="text"  name="sevaprice" class="form-control" id="sevaprice">
                    </div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$sevaprice=$_POST['sevaprice'];
		

		$query = "INSERT INTO addseva(sevaname,sevaprice)VALUES('".$sevaname."','".$sevaprice."')";
		...
		echo "<script>
			...
			echo "<script> location.href='adseva.php'; </script>";
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addseva where id='".$selectano."'";
