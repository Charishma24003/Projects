        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Hall</h4>
                  <form class="forms-sample"  method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="halimg">Hall Image</label>
                      <input type="file" name="image" class="form-control" id="halimg">
                    </div>
                    <div class="form-group">
                      <label for="hlnm">Hall Name</label>
                      <input type="text" name="hallname" class="form-control" id="hlnm" placeholder="Hall Name">
                    </div>
                    <div class="form-group">
                      <label for="seatc">Seating Capacity</label>
                      <input type="text" name="capacity" class="form-control" id="seatc">
                    </div>
                    <div class="form-group">
                      <label for="hlcg">Hall Charge</label>
                      <input type="text" name="charge" class="form-control" id="hlcg">
                    </div>
                    <div class="form-group">
                      <label for="hlam"> Advance Amount</label>
                      <input type="text" name="amount" class="form-control" id="hlam">
                    </div>
                    <div class="form-group">
                      <label>Description of the Hall</label>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
        ...
        $folder = "himg/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO addhall(hallname,capacity,charge,amount,description,image) VALUES('".$hallname."','".$capacity."','".$charge."','".$amount."','".$description."','".$filename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='adhall.php'; </script>";
        }else{
            echo "<script>
...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Hall Details</h4>
	...
	?>
                        <tr>
                          <td><?php echo $sl; ?></td>
                          <td><img  src="himg/<?php echo $image; ?>" alt="error" style="width:140px; height:140px"></td>
					...
					if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addhall where id='".$selectano."'";
