...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Slides</h4>
	...
	?>
                        <tr>
                          <td><?php echo $sl; ?></td>
                          <td><img  src="simg/<?php echo $image; ?>" alt="error" style="width:140px; height:140px"></td>
                          <td>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from slider where id='".$selectano."'";
