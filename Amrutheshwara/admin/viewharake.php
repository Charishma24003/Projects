  ...
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Harake Bookings</h4>
	...
	?>
			<tr style="height:60px">
				...
				<td><?php echo $harake; ?></td>
				<td><?php echo $rharake; ?></td>
