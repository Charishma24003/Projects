        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Yakshagana</h4>
                  <form class="forms-sample" method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="vwimg">Yakshagana Image</label>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
        ...
        $folder = "yimg/".$filename;
		
        if (move_uploaded_file($tempname, $folder))  
		{
			$query ="INSERT INTO addyaksha(clsname,insname,email,time,mcharge,image) VALUES('".$clsname."','".$insname."','".$email."','".$time."','".$mcharge."','".$filename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='adyaksha.php'; </script>";
        }else{
            echo "<script>
...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Yakshagana Details</h4>
                  <div class="table-responsive">
                    <table class="table table-hover">
                      <thead>
                        <tr>
                          <th>Sl.No.</th>
                          <th>Yakshagana Image</th>
                          <th>Class Name</th>
                          <th>Master Name</th>
						  <th>Email</th>
						  <th>Timings</th>
	...
	?>
                        <tr>
                          <td><?php echo $sl; ?></td>
                          <td><img src="yimg/<?php echo $image; ?>" alt="error" style="width:140px; height:140px"></td>
					...
					if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addyaksha where id='".$selectano."'";
