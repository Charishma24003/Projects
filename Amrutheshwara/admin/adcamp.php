        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Add Camp</h4>
                  <form class="forms-sample"  method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="cmpimg">Camp Image</label>
                      <input type="file" name="image" class="form-control" id="cmpimg">
                    </div>
                    <div class="form-group">
                      <label for="cmpnm">Camp Name</label>
                      <input type="text" name="cname" class="form-control" id="cmpnm" placeholder="Camp Name">
                    </div>
                    <div class="form-group">
                      <label for="cmpdt">Date</label>
                      <input type="date" name="date" class="form-control" id="cmpdt">
                    </div>
                    <div class="form-group">
                      <label for="cmptm">Time</label>
                      <input type="text" name="time" class="form-control" id="cmptm">
                    </div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		{
			$query ="INSERT INTO addcamp(cname,date,time,image) VALUES('".$cname."','".$date."','".$time."','".$filename."')";
            mysqli_query($con, $query);
			echo "<script>
					alert(' uploaded Successfully');
				</script>";
			echo "<script> location.href='adcamp.php'; </script>";
        }else{
            echo "<script>
...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Camp Details</h4>
					...
					if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addcamp where id='".$selectano."'";
