        ...
        <div class="content-wrapper">
          ...
          <div class="row">
            <div class="col-md-6 grid-margin stretch-card">
             <img src="tempimgs/img7.jpg" alt="" width="100%" height="100%" style="border-radius:10px; box-shadow: 10px 10px purple;">
            </div>
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      <p class="mb-4">Students enrolled in Yakshagana Classes</p>
                      <p class="fs-30 mb-2">244</p>
              ...
              <div class="row">
                <div class="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      <p class="mb-4">Students enrolled in Bharathanatya Classes</p>
                      <p class="fs-30 mb-2">404</p>
