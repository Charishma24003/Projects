                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="post" action="#" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="adrls">Rules</label>
                      <textarea id="adrls" name="rules" class="form-control" rows="4" cols="50"></textarea>
                    </div>
...
if(isset($_POST['submit']))
{
	...
	include("config.php");
		...
		$query = "INSERT INTO addrules(rules)VALUES('".$rules."')";
		...
		echo "<script>
			...
			echo "<script> location.href='adrules.php'; </script>";
...
?>
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Rules</h4>
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from addrules where id='".$selectano."'";
