        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Bookings Special Days</h4>
                      ...
                      <tbody>
					    <?php
								...
								$status=$row1['status'];
									...
									$sql = "select * from addspecialday  where id='".$festday."' ";
					   ...
					   <td>
							...
							<a href='viewspcld.php?accept=<?php echo $id; ?>'" type="submit" name="accept" class="btn btn-success m-3" >ACCEPT</a>
							</form>
							<form action="#" method="post">
							<input type="text" name="id[]" value="<?php echo $id; ?>" hidden="true">
							<a href='viewspcld.php?reject=<?php echo $id; ?>'" type="submit" name="reject" class="btn btn-danger m-3" >REJECT</a>
							</form>
...
$query = "UPDATE  bksday SET status='".$status."' where id='".$up."'";
...
echo "<script> location.href='viewspcld.php'; </script>";
...
if(isset($_POST['delete']))
{
	...
	$query1 = "delete from bksday where id='".$selectano."'";
