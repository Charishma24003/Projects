...
<body>
  <div class="container-scroller">
        ...
        <div class="content-wrapper">
          <div class="row">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">View Yakshagana Bookings</h4>
	...
	?>
			<tr style="height:60px">
				<td><?php echo $sl; ?></td>
				<td><img  src="yakimg/<?php echo $image; ?>" alt="error" style="width:140px; height:140px; padding:10px 10px;"></td>
