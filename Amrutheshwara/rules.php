...
<head>
	<meta charset="utf-8">
	<title>SHREE AMRUTHESHWARA TEMPLE| RULES TO BE FOLLOWED</title>
	<!-- Stylesheets -->
...
<body>
							...
							<nav class="main-menu navbar-expand-md navbar-light">
								...
								<div class="collapse navbar-collapse clearfix" id="navbarSupportedContent">
									<ul class="navigation clearfix">
										...
										<li class="current dropdown"><a href="ptimings.php">POINTS TO BE NOTED</a>
											<ul>
	...
	<!--End Page Title-->
	<!-- Seva list -->
	<table class="trules" style="width:100%; margin-left:0px; margin-right:0px">
		<tr>
...
<tr>
			<td>2</td>
			<td>Cleanliness of the temple should be maintained.</td>
		</tr>


		<tr>
			<td>3</td>
			<td>Devotees should maintain discipline and follow the rules of Vaidhika Dharma.</td>
		</tr>


		<tr>
			<td>4</td>
			<td>Female devotees should not enter the temple when pregnant after sixth month or late.</td>
		</tr>


		<tr>
			<td>5</td>
			<td>Female devotees should not enter the temple for the first 5 days of their menstruation cycle (period).</td>
		</tr>


		<tr>
			<td>6</td>
			<td>Using mobile phones inside the temple is strictly prohibited.</td>
		</tr>


		<tr>
			<td>7</td>
			<td>Devotees are not allowed to enter the temple with foot wears.</td>
		</tr>


		<tr>
			<td>8</td>
			<td>Chewing betal leaves, tobacco, Gutka is prohibited inside the temple.</td>
		</tr>


		<tr>
			<td>9</td>
			<td>Umbrella, Sticks, Materials made of animal skin should not be brought inside the temple.</td>
		</tr>


		<tr>
			<td>10</td>
			<td>Devotees can get more or specific information from the Executive Officer of the temple.</td>
		</tr>
-->
