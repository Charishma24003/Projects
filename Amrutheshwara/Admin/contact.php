...
<body>
	...
	<div class="page-wrapper">
		...
		<section class="contact-form-section" style="background-color:#fff; padding:10px 10px">
			<div class="auto-container">
				<!-- Sec Title -->
				<div class="sec-title">
					<h2>Get In Touch</h2>
					<div class="text"  style="color:black !important;margin-left:15px">Do you have anything in your mind to let us know? Kindly don't delay to connect to us by means of our contact form.</div>
				</div>
				...
				<div class="contactform" style="flex-direction:row; ">
					...
					<div class="info-column col-lg-5 col-md-12 col-sm-12">
						<div class="inner-column" style="margin-top:150px;border:3px solid var(--primary)">
