...
<body>
	...
	<div class="page-wrapper">
		...
		<div style="display:flex; justify-content:space-evenly; gap:30px;">
			<h3 style="margin-top:80px">
				Thank you for reaching out to us!<br>
				Our temple team will carefully review your message and respond to you shortly.We appreciate youe patience and invite you to explore the spiritual offerings on our website in the meantime.
			</h3>
			<img src="tempimgs/img67.jpg" height="300px" width="350px" style="margin:20px 20px; border-radius:20px">
		</div>
	</div>
